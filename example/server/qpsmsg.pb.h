...
class EchoMessage PROTOBUF_FINAL :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&::descriptor_table_qpsmsg_2eproto);
    return ::descriptor_table_qpsmsg_2eproto.file_level_metadata[kIndexInFileMessages];
  }
...
inline void EchoMessage::set_content(const void* value,
    size_t size) {
...
inline std::string* EchoMessage::unsafe_arena_release_content() {
  // @@protoc_insertion_point(field_unsafe_arena_release:qps_test.EchoMessage.content)
  GOOGLE_DCHECK(GetArena() != nullptr);
  
  return content_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void EchoMessage::unsafe_arena_set_allocated_content(
    std::string* content) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (content != nullptr) {
  ...
  content_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      content, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:qps_test.EchoMessage.content)
}
